...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.setupUi(self)
        self.model = torch.hub.load('C:/Users/张雨生/Desktop/yolov5-5.0', 'custom', 'runs/train/exp3/weights/best.pt', source='local')
        self.timer = QTimer()
    ...
    def open_video(self):
        file_path = QFileDialog.getOpenFileName(self, dir="C:/Users/张雨生/Desktop", filter="*.mp4")
        if file_path[0]:
            file_path = file_path[0]
